  ...
  return (
    <div className="h-48 sm:h-64 flex flex-row sm:flex-col items-center justify-center gap-4 sm:gap-2">
      ...
      <div className="flex-shrink-0">
        <svg
          width={mobileConfig.size}
          height={mobileConfig.size}
        ...
        >
          ...
          <text
            ...
            y={mobileConfig.cy - 4}
            textAnchor="middle"
            className="text-xs sm:text-sm font-medium fill-gray-700 sm:x-[100] sm:y-[94]"
          >
            総支出
          </text>
          <text
            ...
            y={mobileConfig.cy + 8}
            textAnchor="middle"
            className="text-xs fill-gray-600 sm:x-[100] sm:y-[108]"
          >

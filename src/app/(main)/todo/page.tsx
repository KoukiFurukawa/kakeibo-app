    ...
    return (
        <div className="space-y-4 sm:space-y-6">
            ...
            <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg p-4 sm:p-6 space-y-3 sm:space-y-4">
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">タイトル</label>
                    <input
                        type="text"
                        value={title}
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">説明</label>
                    <textarea
                        value={description}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">期限</label>
                        <input
                            type="date"
                            value={dueDate}
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">優先度</label>
                        <select
                            value={priority}
            ...
            <div className="bg-white shadow-md rounded-lg p-4 sm:p-6">
                ...
                {filteredTodos.length === 0 ? (
                    <p className="text-gray-500 text-center py-4 text-sm sm:text-base">
                        {filter === 'all' ? 'ToDoはまだありません' : 
                         filter === 'pending' ? '未完了のToDoはありません' : 
                         '完了したToDoはありません'}
                    </p>
                ) : (
                    <div className="space-y-3">
                        {filteredTodos.map((todo) => (
                            <div key={todo.id} className={`border rounded-lg p-3 ${todo.completed ? 'bg-gray-50' : 'bg-white'}`}>
                                    ...
                                    <div className="flex items-start space-x-3 flex-1">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex flex-wrap gap-2 mt-2 text-xs">
                                                <span className="bg-gray-100 px-2 py-1 rounded">{todo.category}</span>

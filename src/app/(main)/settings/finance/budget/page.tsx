            ...
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                    <div className="p-4 border-b border-gray-200">
                        ...
                        <p className="text-sm text-gray-500 mt-1">各カテゴリの月間予算を設定してください</p>
                    </div>
                    <div className="p-4 space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">食費</label>
                            <div className="relative">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">娯楽</label>
                            <div className="relative">
                                <span className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-500">¥</span>
                                <input
                                    type="number"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">衣服</label>
                            <div className="relative">
                                <span className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-500">¥</span>
                                <input
                                    type="number"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">日用品</label>
                            <div className="relative">
                                <span className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-500">¥</span>
                                <input
                                    type="number"
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                    <div className="flex">
                        ...
                        <div className="ml-3">
                            <h3 className="text-sm font-medium text-blue-800">予算設定について</h3>
                            <div className="mt-2 text-sm text-blue-700">
                                <p>設定した予算は家計簿のダッシュボードで進捗として表示されます。現実的な予算を設定することをおすすめします。</p>
                            </div>
                        </div>
                    </div>
                </div>

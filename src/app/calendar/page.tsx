            ...
            <div className="bg-white shadow-md rounded-lg p-3 sm:p-6">
                ...
                <div className="grid grid-cols-7 gap-1 sm:gap-2">
                    ...
                    {calendarDays.map((day, index) => (
                        <div
                            key={index}
                            className={`min-h-[60px] sm:min-h-[100px] border rounded-md p-1 sm:p-2 ${day === null ? 'bg-gray-100' : 'hover:bg-gray-50'
                                }`}
                        >
                            {day !== null && (
                                <>
                                    ...
                                    <div>
                                        {getDataForDay(day).map((item, i) => (
                                            <div
                                                key={i}
                                                className={`mt-1 p-0.5 sm:p-1 rounded text-[10px] sm:text-xs truncate ${item.type === 'income' ? 'bg-green-100' : 'bg-red-100'
                                                    }`}
                                            >
